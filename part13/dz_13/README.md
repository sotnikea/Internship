...
1. Компілюється і працює з декількома клієнтами - 60
2. Однопоточне обслуговування декількох клієнтів за допомогою select - 20
3. README - 10
4. Детальні коменти у коді - 5  

Загалом 95 із 100   
Помилок, що потребують виправлення, не вказано
